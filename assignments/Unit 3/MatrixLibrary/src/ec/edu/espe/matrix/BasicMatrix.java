...
public class BasicMatrix {
    ...
    public static float[][] loadMatrix(int columns, int rows, String matrixName, Scanner input) {
        float[][] matrix;
    ...
    public static void transposed(int rows, int columns, float[][] t, float[][] matrixA) {
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < columns; j++) {
                t[i][j] = matrixA[j][i];
            }
